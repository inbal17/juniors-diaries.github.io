      ...
      "lessons": [
        {
          ...
          "cards": [
            {
              "term": "TCP Handshake",
              "def": "לחיצת יד משולשת (SYN, SYN-ACK, ACK) המקימה חיבור אמין בין מחשבים."
            },
            {
              "term": "DNS (Port 53)",
              "def": "פרוטוקול תרגום שמות מתחם (Domains) לכתובות IP."
            },
            {
              "term": "ARP Poisoning",
              "def": "מתקפת Man-in-the-Middle לזיוף כתובות MAC ברשת המקומית."
            }
          ],
          "lab": {
          ...
          "interviewQuestions": [
            {
              "q": "מה ההבדל בין TCP ל-UDP ומתי נעדיף כל אחד?",
              "a": "TCP אמין ומבטיח הגעה (HTTP). UDP מהיר ללא בדיקת הגעה (סטרימינג, DNS)."
            }
          ],
        ...
        },
        {
          ...
          "videos": {
            "taste": {
              "url": "",
              "desc": "טעימה (2 דקות): מבנה מערכת הקבצים בלינוקס ומדוע הכל נחשב קובץ."
            },
            "deep": {
              "url": "",
              "desc": "צלילה לעומק (10 דקות): הרשאות קבצים (chmod, rwx) וניהול תהליכים."
            },
            "expert": {
              "url": "",
              "desc": "הופכת למומחית (30 דקות): הרשאות מיוחדות (SUID) והסלמת הרשאות."
            }
          },
          "cards": [
            {
            ...
            {
              "term": "SUID Bit",
              "def": "הרשאה המאפשרת לקובץ לרוץ בהרשאות של הבעלים (כמו root) ולא של המריץ."
            }
          ],
          "lab": {
          ...
          "interviewQuestions": [
            {
              "q": "איך תאתרי בלינוקס קבצים עם הרשאת SUID?",
      ...
      "lessons": [
        {
          ...
          "videos": {
            "taste": {
              "url": "",
              "desc": "טעימה (2 דקות): איך קוד הופך לקובץ בינארי ומה עושה Decompiler?"
            },
            "deep": {
              "url": "",
              "desc": "צלילה לעומק (10 דקות): היכרות עם אוגרים (Registers), ה-Stack ופקודות Assembly בסיסיות ב-x86."
            },
            "expert": {
              "url": "",
              "desc": "הופכת למומחית (30 דקות): פתיחת קובץ CrackMe ב-Ghidra, ניתוח זרימת הפונקציות ועקיפת בדיקת סיסמה."
            }
          },
          "cards": [
            {
              "term": "Register (EAX/RAX)",
              "def": "תא זיכרון מהיר בתוך המעבד המשמש לחישובים והחזרת ערכים מפונקציות."
            },
            {
              "term": "Decompiler",
              "def": "כלי שלוקח שפת מכונה (Assembly) ומתרגם אותה חזרה לקוד קריא דמוי C (למשל Ghidra או IDA)."
            },
            {
              "term": "Buffer Overflow",
              "def": "חולשת זיכרון בה כתיבה מעבר לגודל המערך דורסת זיכרון סמוך ומאפשרת שינוי זרימת התוכנית."
            }
          ],
          "lab": {
          ...
          "interviewQuestions": [
            {
              "q": "מה ההבדל בין ניתוח סטטי (Static Analysis) לניתוח דינמי (Dynamic Analysis)?",
              "a": "ניתוח סטטי בודק את הקוד/בינארי בלי להריץ אותו. ניתוח דינמי מריץ את התוכנה בסביבה מבודדת (Sandbox) ובודק התנהגות בזמן אמת."
            },
            {
              "q": "מה קורה ב-Stack בעת קריאה לפונקציה?",
              "a": "הפרמטרים נדחפים, כתובת החזרה (Return Address) נשמרת, ומסגרת הפונקציה (Stack Frame) מוקמת עבור המשתנים המקומיים."
            }
          ],
      ...
      "lessons": [
        {
          ...
          "videos": {
            "taste": {
              "url": "",
              "desc": "טעימה (2 דקות): מה רואה אנליסטית SOC מול המסך ולמה לוגים הם הראיה החשובה ביותר?"
            },
            "deep": {
              "url": "",
              "desc": "צלילה לעומק (10 דקות): אירועי Security Log קריטיים: 4624 מול 4625."
            },
            "expert": {
              "url": "",
              "desc": "הופכת למומחית (30 דקות): ניתוח שרשרת תקיפה מלאה בלוגים – מ-Pass-the-Hash ועד PowerShell חבוי."
            }
          },
          "cards": [
            {
              "term": "Event ID 4625",
              "def": "אירוע ב-Windows המעיד על כישלון בהתחברות (Failed Logon)."
            },
            {
              "term": "Logon Type 10",
              "def": "התחברות מרחוק באמצעות פרוטוקול RDP."
            }
          ],
          "lab": {
          ...
          "interviewQuestions": [
            {
              "q": "כיצד תבדילי בין משתמש ששכח סיסמה לבין התקפת Brute Force?",
              "a": "תדירות ניסיונות (עשרות בשנייה), שעות לא שגרתיות וכתובת ה-IP של המקור."
            }
          ],
      ...
      "lessons": [
        {
          ...
          "videos": {
            "taste": {
              "url": "",
              "desc": "טעימה (2 דקות): איך שאילתת SQL פשוטה עוקפת מסך התחברות שלם?"
            },
            "deep": {
              "url": "",
              "desc": "צלילה לעומק (10 דקות): ההבדל בין In-band, Blind ו-Time-based SQLi."
            },
            "expert": {
              "url": "",
              "desc": "הופכת למומחית (30 דקות): עקיפת WAF וכתיבת המלצות Remediation לפיתוח."
            }
          },
          "cards": [
            {
              "term": "' OR '1'='1",
              "def": "ביטוי קלאסי ב-SQLi שמחזיר אמת (True) ובכך עוקף אימות."
            },
            {
              "term": "Prepared Statements",
              "def": "ההגנה המובילה נגד SQLi: הפרדת הקוד משאילתת המשתמש על ידי פרמטריזציה."
            }
          ],
          "lab": {
          ...
          "interviewQuestions": [
            {
              "q": "כיצד מונעים SQL Injection ברמת קוד?",
              "a": "שימוש ב-Parameterized Queries / Prepared Statements ו-ORM מאובטח."
            }
          ],
      ...
      "lessons": [
        {
          ...
          "videos": {
            "taste": {
              "url": "",
              "desc": "טעימה (2 דקות): מה ההבדל בין איום, חולשה וסיכון בעולם הסייבר?"
            },
            "deep": {
              "url": "",
              "desc": "צלילה לעומק (10 דקות): בניית מטריצת סיכונים (Likelihood vs Impact)."
            },
            "expert": {
              "url": "",
              "desc": "הופכת למומחית (30 דקות): תהליך הכנה מלא למבדק הסמכה ISO 27001."
            }
          },
          "cards": [
            {
              "term": "Risk = Threat × Vulnerability × Impact",
              "def": "נוסחת הערכת הסיכון הקלאסית באבטחת מידע."
            },
            {
              "term": "Statement of Applicability (SoA)",
              "def": "מסמך יסוד ב-ISO 27001 המגדיר אילו בקרות מיושמות בארגון ומדוע."
            }
          ],
          "lab": {
          ...
          "interviewQuestions": [
            {
              "q": "מהן ארבע הדרכים להתמודד עם סיכון סייבר?",
              "a": "הפחתה (Mitigate), העברה (Transfer), קבלה (Accept), או הימנעות (Avoid)."
            }
          ],
